...
{
    /// <summary>
    /// TOP API: dingtalk.smartwork.bpms.process.sync
    /// </summary>
    public class SmartworkBpmsProcessSyncRequest : BaseDingTalkRequest<DingTalk.Api.Response.SmartworkBpmsProcessSyncResponse>
    {
        /// <summary>
        /// 企业微应用标识
        /// </summary>
